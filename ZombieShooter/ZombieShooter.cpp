...
int main()
{
	...
	// Load the font
	Font font;
	font.loadFromFile("fonts/Blackcraft.ttf");
	...
	pausedText.setString(L"Нажми Enter \nчтобы продолжить");
	...
	gameOverText.setString(L"Нажми Enter чтобы играть");
	...
	scoreText1.setCharacterSize(55);
	scoreText1.setFillColor(Color::White);
	scoreText1.setPosition(20, 0);
	scoreText1.setString(L"Счет: ");
	...
	hiScoreText.setPosition(1600, 0);
	std::stringstream s;
	s <<  hiScore;
	hiScoreText.setString(s.str());

	Text hiScoreText1;
	hiScoreText1.setFont(font);
	hiScoreText1.setCharacterSize(55);
	hiScoreText1.setFillColor(Color::White);
	hiScoreText1.setPosition(1350, 0);
	hiScoreText1.setString(L"Рек Счет:");
	...
	zombiesRemainingText1.setFillColor(Color::White);
	zombiesRemainingText1.setPosition(1500, 980);
	zombiesRemainingText1.setString(L"Зомби: ");
	...
	waveNumberText1.setFillColor(Color::White);
	waveNumberText1.setPosition(1250, 980);
	waveNumberText1.setString(L"Волна: ");
		...
		*/
		...
		if (state == State::PLAYING)
		{
			...
			if (framesSinceLastHUDUpdate > fpsMeasurementFrameInterval)
			{
				...
				// Update the wave
				ssWave << wave;
				waveNumberText.setPosition(1450, 980);
				...
				zombiesRemainingText.setPosition(1700, 980);
		...
		if (state == State::PLAYING)
		{
			...
			window.draw(hiScoreText1);
			window.draw(healthBar);
			window.draw(waveNumberText);
			window.draw(waveNumberText1);
			window.draw(zombiesRemainingText);
			window.draw(zombiesRemainingText1);
